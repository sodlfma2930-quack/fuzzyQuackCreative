(function(){
	...
	if (articleEl) {
		...
		css.textContent = '.search-float{position:fixed;bottom:0;left:0;right:0;z-index:150;padding:12px 20px;padding-bottom:max(12px,env(safe-area-inset-bottom));background:rgba(245,245,247,.85);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-top:1px solid rgba(0,0,0,.08)}.search-float__box{max-width:720px;margin:0 auto;display:flex;gap:8px;align-items:center}.search-float__input{flex:1;border:1px solid #e5e5ea;border-radius:8px;padding:9px 12px;font-size:13px;font-family:inherit;outline:none;transition:border-color .15s;background:#fff}.search-float__input:focus{border-color:#667eea}.search-float__input::placeholder{color:#a1a1a6}.search-float__btn{border:none;border-radius:8px;padding:9px 14px;font-size:12px;font-weight:500;font-family:inherit;cursor:pointer;transition:opacity .15s;white-space:nowrap}.search-float__btn:hover{opacity:.8}.search-float__btn--naver{background:#03c75a;color:#fff}.search-float__btn--google{background:#4285f4;color:#fff}.article{margin-bottom:80px}@media(max-width:600px){.search-float__box{flex-wrap:wrap}.search-float__input{width:100%}.search-float__btn{flex:1}}';
